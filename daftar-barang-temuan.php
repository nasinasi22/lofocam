...
// Query dasar untuk barang ditemukan
$sql = "SELECT id, nama_barang, deskripsi, no_hp, fakultas, kategori, foto_barang, tanggal_temuan 
        FROM barang 
...
<head>
    ...
    <title>Daftar Barang Temuan</title>
    <link rel="stylesheet" href="../css/daftar-barang-temuan.css">
...
<header class="navbar">
    ...
    <div class="nav-container"> <!-- Navbar Container -->
        <ul class="nav-links">
            ...
            <li><a href="daftar-barang-temuan.php" class="active">Daftar Barang Temuan</a></li>
    ...
    <main>
        <aside class="filter-section">
            <form method="GET" action="daftar-barang-temuan.php">
                    ...
                    <tbody>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($row['tanggal_temuan']) ?></td>
                                <td>
                                    <a href="klaim-barang-temuan.php?id=<?= $row['id'] ?>" class="btn btn-primary">Klaim</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
